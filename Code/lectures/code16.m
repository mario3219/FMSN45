...
pred_yk = y(1:pstart-1);                      % This is the predicted yt vector; it is known up to the start of the prediction.
pred_xk = x(1:pstart-1);                      % This is the predicted xt vector; it is known up to the start of the prediction.
